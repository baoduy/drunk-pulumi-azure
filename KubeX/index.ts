...
export namespace types {
  ...
  > & {
    ...
    ports?: pulumi.Input<
      pulumi.Input<k8s.types.input.core.v1.ContainerPort>[] | PortMap
    >;
    volumeMounts?: pulumi.Input<
      pulumi.Input<k8s.types.input.core.v1.VolumeMount | VolumeMount>[]
    >;
  };
  export type PodSpec = Omit<
  ...
  export type ServiceSpec = Omit<
    k8s.types.input.core.v1.ServiceSpec,
    'ports' | 'type'
  > & {
    name?: string;
    ports?: pulumi.Input<
      pulumi.Input<k8s.types.input.core.v1.ServicePort>[] | PortMap
    >;
  ...
  export type StatefulSet = Omit<
    k8s.types.input.apps.v1.StatefulSet,
    'spec'
  > & {
    spec: pulumi.Input<
      StatefulSetSpec | k8s.types.input.apps.v1.StatefulSetSpec
    >;
  };
  ...
  export type CronJob = Omit<k8s.types.input.batch.v1.CronJob, 'spec'> & {
  ...
  export type PodBuilderDeploymentSpec = Omit<
    ...
    'selector' | 'template'
  >;
  export type PodBuilderJobSpec = Omit<
    k8s.types.input.batch.v1.JobSpec,
    'template'
  >;
}

function buildPodSpec(
  args: pulumi.Input<types.PodSpec>
): pulumi.Output<k8s.types.input.core.v1.PodSpec> {
  return pulumi.output<types.PodSpec>(args).apply((podSpec) => {
    ...
    if (podSpec.initContainers) {
      initContainers = podSpec.initContainers.map((container) =>
        buildContainer(container, volumes)
      );
    }
...
function buildContainer(
  container: pulumi.UnwrappedObject<types.Container>,
  volumes: k8s.types.input.core.v1.Volume[]
): k8s.types.input.core.v1.Container {
  const isEnvMap = (env: any): env is pulumi.UnwrappedObject<types.EnvMap> =>
    env.length === undefined;
  const isPortMap = (
    ports: any
  ): ports is pulumi.UnwrappedObject<types.PortMap> =>
    ports.length === undefined;
  const isMountObject = (
    object: any
  ): object is pulumi.UnwrappedObject<types.VolumeMount> =>
...
export class PodBuilder {
  ...
  constructor(args: types.PodSpec) {
    ...
    this.podName = this.podSpec.containers.apply((containers: any) =>
      pulumi.output<string>(containers[0].name)
    );
  }
  ...
  public asJobSpec(
    args?: types.PodBuilderJobSpec
  ): pulumi.Output<k8s.types.input.batch.v1.JobSpec> {
    const appLabels = { app: this.podName };
  ...
  public asCronJobSpec({
    ...
    ...args
  }: Partial<types.PodBuilderJobSpec> &
    Omit<
      k8s.types.input.batch.v1.CronJobSpec,
      'jobTemplate'
    >): pulumi.Output<k8s.types.input.batch.v1.CronJobSpec> {
    const appLabels = { app: this.podName };
    const jobSpec: k8s.types.input.batch.v1.CronJobSpec = {
      schedule,
      concurrencyPolicy,
      failedJobsHistoryLimit,
      startingDeadlineSeconds,
...
export class Pod extends k8s.core.v1.Pod {
  constructor(
    ...
    const isPodBuilder = (
      object: any
    ): object is pulumi.UnwrappedObject<PodBuilder> =>
      object.hasOwnProperty('podSpec');

    const spec: pulumi.Output<k8s.types.input.core.v1.PodSpec> = pulumi
      .output(args.spec)
      .apply((specArg) => {
...
export class Deployment extends k8s.apps.v1.Deployment {
  ...
  constructor(
    name: string,
    args: types.Deployment,
    opts?: pulumi.CustomResourceOptions
  ) {
    const spec: pulumi.Output<k8s.types.input.apps.v1.DeploymentSpec> = pulumi
      .output<types.Deployment>(args)
      .apply((args) => {
  ...
  public createService({ name, ...args }: types.ServiceSpec = {}) {
...
export class Service extends k8s.core.v1.Service {
  ...
  get endpoint(): pulumi.Output<string> {
    return this.status.loadBalancer.ingress.apply(
      (ingress: k8s.types.output.core.v1.LoadBalancerIngress[]) => {
        if (ingress.length > 0) {
...
export class StatefulSet extends pulumi.ComponentResource {
  ...
  constructor(
    name: string,
    args: types.StatefulSet,
    opts?: pulumi.CustomResourceOptions
  ) {
    const spec: pulumi.Output<k8s.types.input.apps.v1.StatefulSetSpec> = pulumi
      .output<types.StatefulSet>(args)
      .apply((args) => {
        const podSpec = buildPodSpec(args.spec.template.spec as types.PodSpec);
        return pulumi.output({
          ...args.spec,
...
export class Job extends k8s.batch.v1.Job {
  ...
  constructor(
    ...
    const spec: pulumi.Output<k8s.types.input.batch.v1.JobSpec> = pulumi
      .output<types.Job>(args)
      .apply((args) => {
        const podSpec = buildPodSpec(args.spec.template.spec as types.PodSpec);
        return pulumi.output({
          ...args.spec,
...
export class ConfigMap extends k8s.core.v1.ConfigMap {
  constructor(
    name: string,
    args: k8s.types.input.core.v1.ConfigMap,
    opts?: pulumi.CustomResourceOptions
  ) {
    super(name, args, opts);
  }
...
export class Secret extends k8s.core.v1.Secret {
  constructor(
    name: string,
    args: k8s.types.input.core.v1.Secret,
    opts?: pulumi.CustomResourceOptions
  ) {
    super(name, args, opts);
  }
